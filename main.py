...
class Ui(QtWidgets.QMainWindow):
    ...
    def regresiButtonPressed(self):
        ...
        my_df.to_csv('dataset_Man.csv', index=False, header=True)

        df = pd.read_csv('dataset_Man.csv')
        ...
        keterangan = "Korelasi Pearson yang digunakan untuk mengetahui tingkat hubungan antara variabel bebas dan terikat adalah sebesar " + \
            str(corr)
    ...
    def aboutMe(self):
        ...
        QtWidgets.QMessageBox.about(
            self, "About Me", "Author. Ryan Cahyadi N\n 15-2018-027\n UTS Pemrograman Simulasi")
        QtWidgets.QApplication.processEvents()
